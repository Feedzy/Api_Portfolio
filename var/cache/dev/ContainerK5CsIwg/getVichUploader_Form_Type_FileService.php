...
return $this->services['vich_uploader.form.type.file'] = new \Vich\UploaderBundle\Form\Type\VichFileType(($this->privates['vich_uploader.storage.file_system'] ?? $this->load('getVichUploader_Storage_FileSystemService.php')), ($this->services['vich_uploader.upload_handler'] ?? $this->load('getVichUploader_UploadHandlerService.php')), ($this->privates['vich_uploader.property_mapping_factory'] ?? $this->load('getVichUploader_PropertyMappingFactoryService.php')), ($this->services['easyadmin.property_accessor'] ?? $this->getEasyadmin_PropertyAccessorService()));
