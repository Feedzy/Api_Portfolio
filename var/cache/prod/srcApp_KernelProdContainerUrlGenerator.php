...
class srcApp_KernelProdContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        'api_techonologies_get_collection' => array(array('_format'), array('_controller' => 'api_platform.action.get_collection', '_format' => null, '_api_resource_class' => 'App\\Entity\\Techonologie', '_api_collection_operation_name' => 'get'), array(), array(array('variable', '.', '[^/]++', '_format', true), array('text', '/api/techonologies')), array(), array()),
        'api_techonologies_post_collection' => array(array('_format'), array('_controller' => 'api_platform.action.post_collection', '_format' => null, '_api_resource_class' => 'App\\Entity\\Techonologie', '_api_collection_operation_name' => 'post'), array(), array(array('variable', '.', '[^/]++', '_format', true), array('text', '/api/techonologies')), array(), array()),
        'api_techonologies_get_item' => array(array('id', '_format'), array('_controller' => 'api_platform.action.get_item', '_format' => null, '_api_resource_class' => 'App\\Entity\\Techonologie', '_api_item_operation_name' => 'get'), array(), array(array('variable', '.', '[^/]++', '_format', true), array('variable', '/', '[^/\\.]++', 'id', true), array('text', '/api/techonologies')), array(), array()),
        'api_techonologies_delete_item' => array(array('id', '_format'), array('_controller' => 'api_platform.action.delete_item', '_format' => null, '_api_resource_class' => 'App\\Entity\\Techonologie', '_api_item_operation_name' => 'delete'), array(), array(array('variable', '.', '[^/]++', '_format', true), array('variable', '/', '[^/\\.]++', 'id', true), array('text', '/api/techonologies')), array(), array()),
        'api_techonologies_put_item' => array(array('id', '_format'), array('_controller' => 'api_platform.action.put_item', '_format' => null, '_api_resource_class' => 'App\\Entity\\Techonologie', '_api_item_operation_name' => 'put'), array(), array(array('variable', '.', '[^/]++', '_format', true), array('variable', '/', '[^/\\.]++', 'id', true), array('text', '/api/techonologies')), array(), array()),
