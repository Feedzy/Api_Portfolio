...
// Returns the private 'App\Repository\TechonologieRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TechonologieRepository.php';

return $this->privates['App\Repository\TechonologieRepository'] = new \App\Repository\TechonologieRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
